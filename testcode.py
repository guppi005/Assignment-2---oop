'''
File: testcode.py
Description: Test cases designed for the maincode.py in the format of unittests.
Author: Bhavya Gupta
StudentID: 110409283
...
class TestAlchemist(unittest.TestCase):
    ...
    def test_refineReagents(self):
        ...
        """ Create instance of Alchemist class to then test its' methods. """
        alchemist = Alchemist(self.potions, self.herbs, self.catalysts)
        """Create the instance of 'Herb' class and 'Catalyst' class with the given name and potency. """
        herb = Herb ("Irit", 3.0) 
...
"""Abstract classes cannot be directly tested. Yet, I tested in case. However, purposely commented out."""
